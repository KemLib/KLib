namespace KLib.Concurrent
{
    ...
    public struct InterValueULong
    {
        ...
        #region Construction
        public InterValueULong()
        {
            value = 0;
        }
        public InterValueULong(ulong value)
        {
            this.value = value;
        }
        #endregion
        ...
        public static implicit operator ulong(InterValueULong tmp) => tmp.value;
        #endregion
    }
}
